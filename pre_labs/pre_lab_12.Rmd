...
**Task** Run the following code and describe the dataframe it outputs. **Press releases and news articles relevant to Maryland Senior Senator Ben Cardin**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Eliminates repetition.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **isolates all unique words from the releases dataframe.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Not really, the most popular words are "the" "and" "to" etc. It doesn't really tell you much.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Yes, gives you a better idea of the content. I don't really know what to make of the percentages, though**
...
**Task** Run the following code and describe the results. **Shows the most popular meaningful words in both datasets, there's a lot of overlap in words such as "act," "Baltimore," "funding," "community," and more. **
...
**Task** Run the following code and describe the results. **Shows the bigram for popular words used in 2022. **
...
**Task** Run the following code and describe the results. **A bigram dataframe with the top two-word phrases in 2024.**
...
**Task** Run the following code and describe the differences between the two results. Which one might be more useful for the press release data? **stem_words, more variety.**
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **Probably unique_words_2024_lemma**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **They generally seem correct. Words like "disaster," and "emergency" are generally negative. This code seems really cool and interesting.**
