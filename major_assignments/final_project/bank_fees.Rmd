...
core_data <- core_data %>% select(-file_number)
core_data <- core_data %>% select(-transaction_id)
core_data <- core_data %>% select(-report_type)
core_data <- core_data %>% select(-committee_id)
core_data <- core_data %>% select(-image_number)
core_data <- core_data %>% select(-line_number)
core_data <- core_data %>% select(-entity_type)
...
core_data <- core_data %>% select(-memo_code)
