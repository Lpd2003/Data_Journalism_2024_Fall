...
**Task** Export the CSV file to your pre_lab_06 folder and read it into R by running the following codeblock. What problems do you see with the data? **Top part of the table came out as data rather than a header column**
...
**Task** Get rid of rows we don't need by running the codeblock below. What problems remain? **Now, top column names are X2, X3, etc rather than the correct header names**
...
**Task** Run the codeblock below. What changed, and what issues or problems remain? **Top column now has appropriate header names.**
