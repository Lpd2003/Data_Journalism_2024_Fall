...
**Reads in the md_voters file
Creates a column for UNAF_DIFF by subtracting the past year from the current year
Creates a new file from the md_voters file arranging the UNAF_DIFFs in order, then by county, then just specifying the top 10.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see an empty ggplot.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A bar graph showing UNAF_DIFF data from different Maryland counties**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **A bar graph showing differences in unaffiliated voters data of Maryland counties organized in order of least to most.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Bar graph of MD counties, now organized in order of most to fewest.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **theme_minimal added**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Darker background, more condensed y-axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Added a whole section for labs**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Winred contributions by person, then organized in total number of contributions by date **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A graph of the winred contributions day to day**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Individual dates added along the x-axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Individual dates more spread out**
