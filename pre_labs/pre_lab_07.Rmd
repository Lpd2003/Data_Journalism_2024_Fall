...
```{r echo=FALSE}
census_api_key("7260853f8e6913702edce23fa10e562cc5b1dcd8", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Nevada, 35.1% increase**
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Howard County with a median household income of 140,971**
...
Is the difference between Calvert and Montgomery significant? **Calvert has a higher margin of error than Montgomery, likely because Montgomery has a much denser population. The difference between their median incomes isn't necessarily significant.**

Is the difference between Howard and everyone else significant? **Fairly significant, Howard has solidly the highest median income by county but isn't far and away the richest county in Maryland.**
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **What do people do for work there? Are rich people more politically involved? Is political participation high in richer zip codes in Maryland?**
