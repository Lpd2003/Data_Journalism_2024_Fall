...
**This code is showing election results by candidate in different MD counties**
...
**In different order,sorted by percent election day**
...
**No, in my opinion it is less interesting. Generally, it lists the candidates with the least amount of votes first, which is less useful.**
...
Source: https://stringr.tidyverse.org/reference/case.html**
...
**It's grouping the contributions by amount. Case_when is being used to mutate data based on multiple conditions. In this case, it categorizes the data in groups based upon the amount of the contribution (less than 100, 100 to 499, etc.) **
...
**Because it only holds the data that we selected**
...
**Dates are different formats (originally MM/DD/YY, changed to YYYY/MM/DD)**
