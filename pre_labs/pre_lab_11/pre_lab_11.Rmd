...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **There's a lot going on- two full names of each candidate and their running mate plus party name...**
...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2 through 6 are referring to? **Column names for candidates, replacing them numerically**
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **55**
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **A list of relevant committees, with irrelevant data on either side. We need to clean it up.**
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **A list of committees with URLs, but some need to be removed.**
